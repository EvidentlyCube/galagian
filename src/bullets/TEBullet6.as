package bullets {
	...
	public class TEBullet6 extends TObject {
		[Embed("../../src.assets/gfx/projectiles/shotwave.png")]
		...
		public function TEBullet6(_x:Number, _y:Number, _spd:Number) {
			Sfx.sound("sh5");
			x = _x;
			y = _y;
			spd = _spd;
			...
			movex = Math.cos(dir) * (_spd + 7);
			movey = Math.sin(dir) * (_spd + 7);
